...
class AssignmentsSamples extends Component {
  ...
  componentDidMount() {
    ...
    const url = `http://192.168.10.6/FWebAPI/api/users/AllDocumentShowSubFolderQuizAndAssignment?courseno=${lib.CNo}&section=${lib.Section}&discipline=${lib.Discipline}&semc=${lib.Semc}&semno=${lib.SemNo}&empno=${lib.TId}&dtype=${this.state.dtype}&dstatus=${this.state.dstatus}`
    fetch(url)
      .then((response) => response.json())
      .then((responsejson) => {
        console.log(responsejson)
  ...
  GetFolderDetailId() {
    const url = `http://192.168.10.6/FWebAPI/api/Users/GetFolderDetailIdSubFolderQuizAndAssignment?courseno=${lib.CNo}&section=${lib.Section}&discipline=${lib.Discipline}&semc=${lib.Semc}&semno=${lib.SemNo}&empno=${lib.TId}&dtype=${this.state.dtype}&dstatus=${this.state.dstatus}`
    fetch(url)
      .then((response) => response.json())
      .then((responsejson) => {
        console.log(responsejson)
